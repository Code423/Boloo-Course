...
1-  Waardevolle soorten producten:

- > Is het een product dat opgaat en bijgevuld moet worden (luiers, borstvoeding etc.)? +1

- > Is het een product dat probleemoplossend is voor mensen (klok)? +1

- > Is het een product dat wordt gekocht uit zorg voor een ander (baby, kind of dier)? +1

- > Is het een product dat een consument aanschaft voor een fysiek pijnlijke reden? +1

- > Is het een product waarbij emoties in het spel zijn (beauty, fitness, welzijn)? +1
---

2- Categorieën voor starters:
...
- > Duurder = beter
- > Onbewuste aanname dat het hoog kwaliteit is door de prijs.
- > High ticket: 50 > 200 euro.
  > Prijs boven 25 is gratis verzenden.
---
...
- > Verkoop meer productne in een niche(categorie)
  > Kan je meer aansluitende producten onder deze categorie aanbieden?  Dan een merk bouwen
---

8- De bron van het product:
  - is waar je het product inkoopt.

- > Track record van het product & de fabriek
  > MQ weten: Minimum Quantiteit die je moet bestelen.
    - Stel je voor: dat het product op is, je hebt geen genoeg geld om het minmum te inkopen of de qualiteit niet goed is.
---
## SamenVatten:
-De eigenschappen van producten met potentie
- > 1- De winst
- > 2- Het soort product
- > 3- Concurrenten
- > 4- Onderscheidend vermogen
- > 5- High ticket product
- > 6- Niche uitbreiding
- > 7- Seizoensgebonden
...
<hr>
    11- Eigenschap 4: Hoe stabiel is de omzet/sales over de afgelopen 6 maanden? "KOLOM" (STABILITEIT)<br>
      ...
      Grote schommelingen / Sterk seizoensgebonden (2 punten): Heel grillig verloop met gigantische drops
      (bijvoorbeeld maanden waarin de omzet meer dan halveert ten opzichte van de topmaand).
      
      Gemiddelde stabiliteit (3 punten): Er zijn duidelijke pieken en dalen zichtbaar,
      maar er blijft wel elke maand een gezonde basisomzet binnenkomen.
